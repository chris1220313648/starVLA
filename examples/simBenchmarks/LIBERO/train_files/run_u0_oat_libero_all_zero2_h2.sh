...
export RUN_ID="${RUN_ID:-u0_oat_libero_all_zero2_h2_20k}"
export MAX_TRAIN_STEPS="${MAX_TRAIN_STEPS:-20000}"
export SAVE_INTERVAL="${SAVE_INTERVAL:-5000}"
# Match the validated U0 h=2 global batch: 4 x 8 GPUs x accumulation 8 = 256.
...
SOURCE_CONFIG="$SCRIPT_DIR/u0_oat_libero_all_h2.yaml"
